...
class JgPush 
{
    ...
    // 通用的消息推送方法
    static public function pushToApp($uid, $type, $alert, $title, $extras) {
    ...
    static private function getJpush()
    {
        ...
        $app_key = '1eb0b95c0f28e6738f90770e';
        $master_secret = '1801c3a9c8b292c47ca504b6';
