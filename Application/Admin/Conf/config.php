...
return array(
    ...
    'DOWNLOAD_UPLOAD' => array(
        ...
        'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,avi,wmv,mp4', //允许上传的文件后缀
        'autoSub'  => true, //自动子目录保存文件
        'subName'  => array('date', 'Y-m-d'), //子目录创建方式，[0]-函数名，[1]-参数，多个参数使用数组
        'rootPath' => './Public/u/d/', //保存根路径
        'savePath' => '', //保存路径
    ...
    'PICTURE_UPLOAD' => array(
		...
		'exts'     => 'jpg,gif,png,jpeg,avi,wmv,mp4', //允许上传的文件后缀
		'autoSub'  => true, //自动子目录保存文件
		'subName'  => array('date', 'Y-m-d'), //子目录创建方式，[0]-函数名，[1]-参数，多个参数使用数组
		'rootPath' => './Public/u/p/', //保存根路径
		'savePath' => '', //保存路径
		'saveName' => array('uniqid', ''), //上传文件命名规则，[0]-函数名，[1]-参数，多个参数使用数组
		'saveExt'  => '', //文件保存后缀，空则使用原后缀
		'replace'  => false, //存在同名是否覆盖
    ...
    'UPLOAD_QINIU_CONFIG'=>array(
        ...
        'bucket'=>'hiithinktest',
        'domain'=>'hiithinktest.u.qiniudn.com',
        'timeout'=>3600,
    ),
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__ADDONS__' => __ROOT__ . '/Public/res/' . MODULE_NAME . '/Addons',
        '__IMG__'    => __ROOT__ . '/Public/res/' . MODULE_NAME . '/images',
