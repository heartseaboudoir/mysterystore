...
defined('CAIJI_NAME') or define('CAIJI_NAME', 'store_order_week');

set_time_limit(300);

$s_time = strtotime('-1 monday', time());  //上周一
$e_time = strtotime('monday', time());  //本周一
$sql_e_time = strtotime('-1 day',$e_time);  //上周末
$time = time();
$year = date('Y');  //当前年
// 连接数据库
