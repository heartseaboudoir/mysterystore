...
class WechatAddon extends Addon {
    ...
    public $info = array(
        ...
        'author' => 'huay1',
        'version' => '1.0',
        'adminlist_url' => 'Addons/execute?_addons=Wechat&_controller=WechatConfig&_action=index'
    );
...
//    );
    ...
    public function install() {
        ...
        $install_sql = './Addons/Wechat/install.sql';
    ...
    public function uninstall() {
        $install_sql = './Addons/Wechat/uninstall.sql';
        if (file_exists ( $install_sql )) {
                execute_sql_file ( $install_sql );
        }
        $Hooks = M("Hooks");
