...
class BackToWarehouseModel extends Model
{
    ...
    public function createIndexListExcel($data, $title, $fname)
    {
        ...
        $objActSheet->setCellValue('H' . $rowNum, '返回仓库');
        $objActSheet->setCellValue("I" . $rowNum, '售价金额');
        $objActSheet->setCellValue("J" . $rowNum, '申请结果');
        ...
        foreach ($data as $key => $val) {
            ...
            $objActSheet->setCellValue('B' . $rowNum, $val['s_back_sn']);
            ...
            $objActSheet->setCellValue('J' . $rowNum, $val['s_back_status_name']);
    ...
    public function createViewExcel($data, $title, $fname)
    {
        ...
        $rowNum = 2;
        $objActSheet->setCellValue("A" . $rowNum, "申请单号");
        $objActSheet->setCellValue("B" . $rowNum, $maindata["s_back_sn"]);
        ...
        $objActSheet->setCellValue("D" . $rowNum, "申请门店");
        $objActSheet->setCellValue("E" . $rowNum, $maindata["store_name"]);
        $objActSheet->setCellValue("G" . $rowNum, "返仓仓库");
        $objActSheet->setCellValue("H" . $rowNum, $maindata["warehouse_name"]);

        $rowNum = 5;
        $objActSheet->setCellValue("A" . $rowNum, "单据状态");
        $objActSheet->setCellValue("B" . $rowNum, $maindata["s_back_status_name"]);
