...
class AopClient {
	...
	public function execute($request, $authToken = null, $notify_url = null) {
	...
	function echoDebug($content){
        ...
        public function getRsaPriString(){
            $string = file_get_contents($this->rsaPrivateKeyFilePath);
            $string = str_replace(array("-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", "\n"), array('', '', ''), $string);
            return $string;
        }
        public function getRsaPubString($path){
            $string = file_get_contents($path);
            $string = str_replace(array("-----BEGIN PUBLIC KEY-----", "-----END PUBLIC KEY-----", "\n"), array('', '', ''), $string);
            return $string;
        }
